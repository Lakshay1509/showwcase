          ...
          <div className="flex items-center justify-end gap-4">
            ...
            <ClerkLoaded>
              {!isSignedIn ? (
                <>
                  <Link
                    className="hidden items-center justify-center rounded-xl bg-gray-800/50 px-4 py-2 text-sm font-medium text-gray-200 shadow-sm ring-1 ring-gray-700/50 transition-all duration-300 hover:bg-gray-700/50 hover:text-white sm:inline-flex"
                    href="/sign-up"
                  >
                    Sign up
                  </Link>
                  <Link
                    className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all duration-300 hover:from-blue-500 hover:to-purple-500"
                    href="/sign-in"
                  >
                    Sign in
                  </Link>
